...
TEST(TestLayerLocalFieldConvolution, StaticInstanceColEmbedding_Forward)
{
  using Layer  = ffnn::layer::Layer<float>;
  using Input  = ffnn::layer::Input<float>;
  using Convolution = ffnn::layer::LocalFieldConvolution<float, 16, 16, 3, 4, 4, 4, 1, ffnn::layer::ColEmbedding>;
